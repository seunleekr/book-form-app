  ...
  return (
    <aside style={{ 
      ...
      <div style={{
        ...
        {debouncedFormValues.title != null && (
          <div style={{ marginBottom: 16 }}>
            ...
            {debouncedFormValues.author != null && (
              <p style={{ 
                fontSize: "14px", 
                color: "#6b7280", 
                margin: 0,
        ...
        {debouncedFormValues.status != null && (
        ...
        {debouncedFormValues.recommended != null && debouncedFormValues.recommended && (
          <div style={{ 
            marginBottom: 16,
            padding: "8px 12px",
            background: "#fef3c7",
        ...
        {debouncedFormValues.review != null && (
          <div style={{ marginBottom: 16 }}>
            <div style={{ 
              fontSize: "13px", 
              fontWeight: 600, 
        ...
        {debouncedFormValues.quotes != null && debouncedFormValues.quotes.length > 0 && debouncedFormValues.quotes.some(q => q.text != null) && (
          <div style={{ marginBottom: 16 }}>
            <div style={{ 
              fontSize: "13px", 
              fontWeight: 600, 
              ...
              인용구 ({debouncedFormValues.quotes.filter(q => q.text != null).length}개)
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {debouncedFormValues.quotes.filter(q => q.text != null).map((quote, index) => (
                <div key={index} style={{
                  padding: 12,
                  background: "#ffffff",
                  borderRadius: 8,
        ...
        {debouncedFormValues.totalPages != null && (
          <div style={{ 
            fontSize: "13px", 
            color: "#6b7280",
            marginBottom: 12,
